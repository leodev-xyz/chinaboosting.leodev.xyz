    ...
    return (
        <>
            <MetaTags
                ...
                description="中文 CS:GO 账号提升。 XP+等级提升50元起。Chinese CS:GO account boosting. XP + RANK boosting starting at 50¥."
            />
            ...
            <div className="max-w-lg mx-auto mt-20 sm:px-4">
                ...
                <h2 className="mt-10 mb-4 text-xl font-bold uppercase">
                    为我们工作！ Work for us!
                </h2>
                <div className="grid grid-cols-2 gap-2">
                    <button
                        ...
                        onClick={() => {
                            setName(GenerateChineseName(2 + Math.floor(Math.random() * 4)))
                        }}
                    >
                        加入团队！
                    </button>
                    <button
                        className="uppercase --btn --btn-3 --btn-primary"
                        onClick={() => {
                            setName(GenerateChineseName(2 + Math.floor(Math.random() * 4)))
                        }}
                    >
